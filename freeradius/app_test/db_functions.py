...
def test_same_max_id(db_session: Session):
    return True if get_max_from_radcheck(db_session, RadCheck.id) == get_max_from_radreply(db_session, RadReply.id) == get_max_from_radusergroup(db_session, RadUserGroup.id) else False      
